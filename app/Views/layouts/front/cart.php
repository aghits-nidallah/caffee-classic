<div class="sidebar-menu-wrapper">
        <div class="cart_sidebar">
            ...
            <div class="cart_items_list">
                ...
                <div class="cart_item">
                    <div class="item_image">
                        <img src="<?= base_url('assets-front/images/recent_post/img_04.jpg') ?>" alt="image_not_found">
                    </div>
                    <div class="item_content">
                        <h4 class="item_title">
                            Rorem ipsum dolor sit amet, sectetur adipisi cingey.
                ...
                <div class="cart_item">
                    <div class="item_image">
                        <img src="<?= base_url('assets-front/images/recent_post/img_05.jpg') ?>" alt="image_not_found">
                    </div>
                    <div class="item_content">
                        <h4 class="item_title">
                            Rorem ipsum dolor sit amet, sectetur adipisi cingey.
                ...
                <div class="cart_item">
                    <div class="item_image">
                        <img src="<?= base_url('assets-front/images/recent_post/img_06.jpg') ?>" alt="image_not_found">
                    </div>
                    <div class="item_content">
                        <h4 class="item_title">
                            Rorem ipsum dolor sit amet, sectetur adipisi cingey.
